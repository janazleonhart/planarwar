...
export const HELP_ENTRIES: { cmd: string; desc: string; debug?: boolean }[] = [
  ...
  { cmd: "tip: ranged", desc: "Ranged attacks require range + line-of-sight. If you see a facing warning, turn toward your target (UI facing controls planned)." },
  { cmd: "tip: outrider", desc: "Outrider sustain: use shoot/fire/throw and autofire between spell cooldowns." },
