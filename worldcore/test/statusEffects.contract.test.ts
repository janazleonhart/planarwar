// worldcore/test/contracts/statusEffects.contract.test.ts
//
// Compile-time “contract guard” for StatusEffects.
// This ensures the snapshot keeps its key fields used by combat math/tests.
...
test("[contract] StatusEffects snapshot has required fields", () => {
  ...
  // Runtime sanity (and compile-time shape via CombatStatusSnapshot typing)
