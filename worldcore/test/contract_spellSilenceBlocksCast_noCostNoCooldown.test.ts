// worldcore/test/contract_spellSilenceBlocksCast_noCostNoCooldown.test.ts
//
// Contract: silence must deny spell casting BEFORE spending resources or starting cooldowns.
...
test("[contract] silence blocks casting before cost/cooldown", async () => {
  ...
  assert.equal(String(out).includes("silenced"), true);
