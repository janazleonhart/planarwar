// worldcore/test/contract_dispelPriorityTagsRemovesHighPriorityFirst.test.ts
...
test("[contract] dispel honors priorityTags when maxToRemove is limited", async () => {
  ...
  try {
    ...
    const spell: SpellDefinition = {
      id: "test_dispel_single_npc_priority",
      name: "Test Dispel",
      ...
      resourceCost: 0,
      cooldownMs: 0,
      dispel: { tags: ["buff"], maxToRemove: 1, priorityTags: ["major"] },
    };
