...
// Runic Knight reference kit (L1–10)
// NOTE: Uses Runic Power (runic_power) as a combat-building spender resource.
runic_knight_rune_strike: {
  id: "runic_knight_rune_strike",
  name: "Rune Strike",
  kind: "damage_single_npc",
  classId: "runic_knight",
  minLevel: 1,
  description: "A runed cleave that carves a little meaning into the target’s existence.",
  school: "shadow",
...
runic_knight_frost_brand: {
  id: "runic_knight_frost_brand",
  name: "Frost Brand",
  kind: "debuff_single_npc",
  classId: "runic_knight",
  minLevel: 3,
  description: "A freezing rune that dulls the target’s will to strike true.",
  school: "frost",
  statusEffect: {
...
runic_knight_blood_siphon: {
  id: "runic_knight_blood_siphon",
  name: "Blood Siphon",
  kind: "heal_self",
  classId: "runic_knight",
  minLevel: 5,
  description: "Steal back a sliver of vitality. The rune doesn’t care whose it was originally.",
  school: "shadow",
  resourceType: "runic_power",
  resourceCost: 12,
  cooldownMs: 10000,
...
runic_knight_bone_shield: {
  id: "runic_knight_bone_shield",
  name: "Bone Shield",
  kind: "shield_self",
  classId: "runic_knight",
  minLevel: 7,
  description: "A lattice of bone-runes hardens around you, catching the next blows.",
  school: "shadow",
  statusEffect: {
...
runic_knight_plague_strike: {
  id: "runic_knight_plague_strike",
  name: "Plague Strike",
  kind: "damage_dot_single_npc",
  classId: "runic_knight",
  minLevel: 9,
  description: "A cursed wound that festers on a schedule. Your calendar. Their problem.",
  school: "shadow",
  statusEffect: {
